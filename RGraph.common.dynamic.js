                    ...
                    for (var i=0,len=objects.length; i<len; i+=1) {
                        ...
                        */
                        ...
                        if (   shape
                            ...
                            && (    RG.isNull(RG.Registry.get('chart.tooltip'))
                                || obj.uid != RG.Registry.get('chart.tooltip').__object__.uid
                                || (!shape || RG.Registry.get('chart.tooltip').__index__ != shape['index'])
                                || (shape['dataset'] || (typeof shape['dataset'] == 'number' && shape['dataset'] != RG.Registry.get('chart.tooltip').__shape__['dataset']))
                                )
                           ) {
